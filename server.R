...
shinyServer(function(input, output,session) {
    ...
    archtypes.scores.comp<-function(fishery.labs)
    {
      ...
      colnames(scores)<-colnames(scores.fish)<-c("Data_Type","Data_Precision","Data_Bias","Data_Species ID","Data_Spatial","Data_Temporal","Res_Time","Res_Funding","Res_Capacity","Res_analysts_stocks")
