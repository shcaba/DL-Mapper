    ...
    #            color = "success"
     #       ),
            ...
            column(width=6,sliderInput("D_prez",
                        ...
                        step=0.1,
                        value = 3))),
            bsTooltip("D_type", "Different types of data available, such as catch, indices of abundnace and/or biological data. The more data, the less constraints on data type. 3 = no available data, and all other data should also be scored 3.",
