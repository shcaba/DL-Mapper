    ...
    #            color = "success"
     #       ),
            ...
            column(width=6,sliderInput("D_prez",
                        ...
                        step=0.1,
                        value = 3))),
            bsTooltip("D_type", "Different types of data available, such as catch, indices of abundance and/or biological data. The more data, the less constraints on data type. 3 = no available data, and all other data should also be scored 3.",
...
#            br(),
            ...
            fluidRow(column(width=4,h3("Biplot of average attribute scores", align = "center")),
                     column(width=8,h3("Comparison of attribute scores across example fisheries", align = "left"))),
